...
#Loading the data. If read_csv does not work with data/cleaner_cred_score_classifier, please import local data file location
...
class creditScore(Page):
    ...
    def title(self):
        ...
        #Pulling inputs from 1_fill_information file
    def input(self):
    ...
    def buildModel(self):
        ...
        clf.fit(
            x = cleanData,
            y = data['Credit_Score'], # fico score good/standard/poor
